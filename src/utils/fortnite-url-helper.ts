...
export class FortniteURLHelper {
  ...
  public static readonly friendsPublicUrl: string =
  ...
  public static lookupById: string = `${FortniteURLHelper.accountPublicUrl}/public/account`;
  ...
  public static sendFriendRequest: string =
    'https://accounts.launcher-website-prod07.ol.epicgames.com/launcher/sendFriendRequest';
